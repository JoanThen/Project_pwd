...
<body class="min-h-screen font-sans text-white flex items-center justify-center"
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div class="py-5 px-6"
                 style="background: radial-gradient(circle at center, #0d47a1 0%, #0a1931 60%, #000000 100%);">
                <h2 class="text-xl font-medium text-white">Welcome Back</h2>
                <p class="text-sky-50 text-sm mt-1">Login to access your dashboard</p>
            </div>
                ...
                <form method="POST" action="/login">
                    ...
                    <div class="mb-4">
                        <div class="flex items-center justify-between mb-2">
                            <label for="password" class="block text-slate-600 text-sm font-medium">Password</label>
                            <a href="#" class="text-xs text-sky-500 hover:text-sky-600">Forgot password?</a>
                        </div>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    ...
                    <div class="flex items-center mb-4">
                        <input type="checkbox" id="remember" name="remember" class="h-4 w-4 text-sky-500 focus:ring-sky-400 border-slate-300 rounded">
                        <label for="remember" class="ml-2 block text-sm text-slate-500">Remember me</label>
                    </div>
                    ...
                    <div class="text-center mt-5">
                        ...
                        <a href="{{ route('register') }}" class="text-sky-500 hover:text-sky-600 text-sm font-medium ml-1">
                            Create an account
                        </a>
                    </div>
                </form>
